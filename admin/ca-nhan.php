...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    echo '<script type="text/JavaScript"> window.location.href = "http://localhost:8080/webbansach/admin/ca-nhan.php"; </script>';
}
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-2" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nhập mã nhân viên"
                                        class="form-control form-control-line" required disabled
                                        value="<?php echo $result['manhanvien']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nhập tài khoản"
                                        class="form-control form-control-line" required name="taikhoan" disabled
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nhập họ tên" class="form-control form-control-line"
                                        required name="hoten" value="<?php echo $result['hoten']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nhập số điện thoại"
                                        class="form-control form-control-line" required name="sodienthoai"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nhập địa chỉ" class="form-control form-control-line"
                                        required name="diachi" value="<?php echo $result['diachi']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="password" placeholder="Nhập mật khẩu"
                                        class="form-control form-control-line" name="matkhau">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
