            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">
                            Chuyên Mục
                            <a class="btn btn-success text-white" style="float: right;" href="them-chuyen-muc.php">Thêm
                                Chuyên Mục</a>
                        </h4>
                        <h6 class="card-subtitle">Thông tin các chuyên mục sản phẩm trong cửa hàng</h6>
                        <h6 class="card-title m-t-40"><i
                                class="m-r-5 font-18 mdi mdi-numeric-1-box-multiple-outline"></i> Danh sách chuyên mục
                        </h6>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <?php while ($row = $result->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="sua-chuyen-muc.php?id=<?php echo $row['machuyenmuc']; ?>"
                                                        style="margin-right: 20px;"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    <a href="xoa-chuyen-muc.php?id=<?php echo $row['machuyenmuc']; ?>"><i
