                    ...
                    <div class="card-body">
                        ...
                        <div class="feed-widget">
                            <ul class="list-style-none feed-body m-0 p-b-20">
                                <li class="feed-item">
                                    <div class="feed-icon bg-info"><i class="far fa-bell"></i></div> Bạn có
                                    <?php echo $chuagiao ?> đơn hàng mới! <span
                                        class="ms-auto font-12 text-muted"></span>
                                </li>
                                <li class="feed-item">
                                    <div class="feed-icon bg-success"><i class="ti-server"></i></div> Doanh thu hôm nay
                                    là: <?php echo number_format($doanhthu ?? 0); ?>đ<span
                                        class="ms-auto font-12 text-muted"></span>
                                </li>
                                <li class="feed-item">
                                    <div class="feed-icon bg-warning"><i class="ti-shopping-cart"></i></div> Tổng số sản
                                    phẩm trong cửa hàng là: <?php echo $slsp; ?> sản phẩm<span
                                        class="ms-auto font-12 text-muted"></span>
                                </li>
                                <li class="feed-item">
                                    <div class="feed-icon bg-danger"><i class="ti-user"></i></div> Số lượng khách hàng
                                    mới trong hôm nay là: <?php echo $slkh; ?> khách hàng<span
                                        class="ms-auto font-12 text-muted"></span>
                                </li>
                            </ul>
                        </div>
