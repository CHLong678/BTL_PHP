            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">
                            Sản Phẩm
                            <a class="btn btn-success text-white" style="float: right;" href="them-san-pham.php">Thêm
                                Sách</a>
                        </h4>
                        <h6 class="card-subtitle">Thông tin các sản phẩm trong cửa hàng</h6>
                        <h6 class="card-title m-t-40"><i
                                class="m-r-5 font-18 mdi mdi-numeric-1-box-multiple-outline"></i> Danh sách sản phẩm
                        </h6>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <?php while ($row = $result->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="sua-san-pham.php?id=<?php echo $row['masanpham']; ?>"
                                                        style="margin-right: 10px;"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    <a href="xoa-san-pham.php?id=<?php echo $row['masanpham']; ?>"><i
