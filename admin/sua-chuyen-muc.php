...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    echo '<script type="text/JavaScript"> window.location.href = "http://localhost:8080/webbansach/admin/chuyen-muc.php"; </script>';
}
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-2" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nhập mã chuyên mục"
                                        class="form-control form-control-line" name="machuyenmuc"
                                        value="<?php echo $chuyenmuc['machuyenmuc']; ?>" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Tên Chuyên Mục</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nhập tên chuyên mục"
                                        class="form-control form-control-line" name="tenchuyenmuc"
                                        value="<?php echo $chuyenmuc['tenchuyenmuc']; ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
