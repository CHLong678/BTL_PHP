...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    echo '<script type="text/JavaScript"> window.location.href = "http://localhost:8080/webbansach/admin/san-pham.php"; </script>';
}
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-2" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nhập tên sản phẩm"
                                        class="form-control form-control-line" name="tensanpham"
                                        value="<?php echo $sanpham['tensanpham']; ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Giá gốc</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nhập giá gốc" class="form-control form-control-line"
                                        name="giagoc" value="<?php echo $sanpham['giagoc']; ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Giá bán</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nhập giá bán" class="form-control form-control-line"
                                        name="giaban" value="<?php echo $sanpham['giaban']; ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Mô tả ngắn</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nhập mô tả" class="form-control form-control-line"
                                        name="motangan" value="<?php echo $sanpham['mota']; ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea type="text" placeholder="Nhập mô tả chi tiết"
                                        class="form-control form-control-line" name="motachitiet" rows="5"
                                        required><?php echo $sanpham['motachitiet']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <select class="form-select shadow-none form-control-line" name="machuyenmuc">
                                        <?php while ($row = $result_chuyenmuc->fetch_assoc()) { ?>
                                            <?php if ($sanpham['machuyenmuc'] == $row['machuyenmuc']) { ?>
                                                <option value="<?php echo $row['machuyenmuc']; ?>" selected>
                                                    <?php echo $row['tenchuyenmuc']; ?>
                                                </option>
                                            <?php } else { ?>
                                                <option value="<?php echo $row['machuyenmuc']; ?>">
                                                    <?php echo $row['tenchuyenmuc']; ?>
                                                </option>
                                            <?php } ?>
                                        <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Thẻ cách nhau bởi dấu ,"
                                        class="form-control form-control-line" name="tag"
                                        value="<?php echo $sanpham['tag']; ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <br>
                                <img src="<?php echo 'http://localhost:8080/webbansach/' . $sanpham['anhchinh']; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <img src="<?php echo 'http://localhost:8080/webbansach/' . $sanpham['anhphu1']; ?>"
                                    alt="" style="width: 200px; height: 200px;">
                            </div>
                            <div class="form-group">
                                ...
                                <br>
                                <img src="<?php echo 'http://localhost:8080/webbansach/' . $sanpham['anhphu2']; ?>"
                                    alt="" style="width: 200px; height: 200px;">
                            </div>
                            <div class="form-group">
                                ...
                                <br>
                                <img src="<?php echo 'http://localhost:8080/webbansach/' . $sanpham['anhphu3']; ?>"
                                    alt="" style="width: 200px; height: 200px;">
                            </div>
                            <div class="form-group">
                                ...
                                <br>
                                <img src="<?php echo 'http://localhost:8080/webbansach/' . $sanpham['anhphu4']; ?>"
                                    alt="" style="width: 200px; height: 200px;">
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
