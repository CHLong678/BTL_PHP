                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nhập tên sản phẩm"
                                        class="form-control form-control-line" required name="tensanpham">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea type="text" placeholder="Nhập mô tả chi tiết"
                                        class="form-control form-control-line" required name="motachitiet"
                                        rows="5"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-select shadow-none form-control-line" required
                                        name="machuyenmuc">
                                        <?php while ($row = $result->fetch_assoc()) { ?>
                                            <option value="<?php echo $row['machuyenmuc']; ?>">
                                                <?php echo $row['tenchuyenmuc']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Thẻ cách nhau bởi dấu ,"
                                        class="form-control form-control-line" required name="tag">
                                </div>
                            </div>
                            <div class="form-group">
