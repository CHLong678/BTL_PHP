...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['dangky'])) {
	...
	if ($matkhau != $nhaplaimatkhau) {
		...
		$sql_check = "SELECT count(*) AS num FROM khachhang WHERE taikhoan = '" . $taikhoan . "' OR sodienthoai = '" . $sodienthoai . "'";
		...
		if ($check['num'] == 0) {
			...
			$err = "Tài khoản hoặc số điện thoại đã tồn tại!";
		}
	}
}
					...
					<div class="login-form">
						...
						<div class="row">
							<div class="col-md-12 col-12 mb--15">
								...
								<input class="mb-0 form-control" type="text" id="name" placeholder="Nhập tên bạn.." name="hoten">
							...
							<div class="col-12 mb--20">
								...
								<input class="mb-0 form-control" type="text" id="sdt" placeholder="Nhập số điện thoại.."
									name="sodienthoai">
							...
							<div class="col-lg-6 mb--20">
								...
								<input class="mb-0 form-control" type="password" id="password-confirm" placeholder="Nhập lại mật khẩu.."
									name="nhaplaimatkhau">
					...
					<div class="login-form">
						...
						<div class="row">
							<div class="col-md-12 col-12 mb--15">
								...
								<input class="mb-0 form-control" type="text" id="email1" placeholder="Nhập tài khoản.." name="taikhoan">
								<span id="span_error_tk"></span>
							</div>
							<div class="col-12 mb--20">
								<label for="password">Mật khẩu</label>
								<input class="mb-0 form-control" type="password" id="login-password" placeholder="Nhập mật khẩu.."
									name="matkhau">
