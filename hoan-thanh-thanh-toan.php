...
<script>
	$(document).ready(function () {
		...
		for (var i = 0; i < donhangthanhcong.length; i++) {
			...
			$('tbody').append('<tr> <td><a href="http://localhost:8080/webbansach/san-pham.php?id=' + donhangthanhcong[i].masanpham + '">' + donhangthanhcong[i].tensanpham + '</a> <strong>× ' + donhangthanhcong[i].soluong + '</strong></td> <td><span>' + gia.toLocaleString('vi', { style: 'currency', currency: 'VND' }) + '</span></td> </tr>')
		}
