        ...
        <div class="row space-db--30">
            <div class="col-lg-6 col-md-6 mb--30">
                <a href="" class="promo-image promo-overlay">
                    <img src="http://localhost:8080/webbansach/admin/upload/ms_banner_img2.png" alt="">
                </a>
            </div>
            <div class="col-lg-6 col-md-6 mb--30">
                <a href="" class="promo-image promo-overlay">
                    <img src="http://localhost:8080/webbansach/admin/upload/ms_banner_img3.png" alt="">
                </a>
            </div>
        </div>
    </div>
                            ...
                            <div class="single-slide">
                                <div class="product-card">
                                    <div class="product-header">
                                        ...
                                        <h3><a
                                                href="san-pham.php?id=<?php echo $row['masanpham']; ?>"><?php echo $row['tensanpham']; ?></a>
                                        </h3>
                                    </div>
                                    <div class="product-card--body">
                                        <div class="card-image">
                                            <img src="http://localhost:8080/webbansach/<?php echo $row['anhchinh']; ?>"
                                                alt="" style="width: 220px; height:220px; ">
                                            <div class="hover-contents">
                                                <a href="san-pham.php?id=<?php echo $row['masanpham']; ?>"
                                                    class="hover-image">
                                                    <img src="http://localhost:8080/webbansach/<?php echo $row['anhphu1']; ?>"
                                                        alt="" style="width: 220px; height:220px; ">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="price-block">
                                            ...
                                            <span
                                                class="price-discount">-<?php echo number_format($row['giagoc'] - $row['giaban']); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="product-card card-style-list">
                        <div class="card-image">
                            <img src="<?php echo $row['anhchinh']; ?>" alt=""
                                style="width: 150px; height: 150px; image-rendering: -webkit-optimize-contrast;">
                        </div>
                        <div class="product-card--body">
                            <div class="product-header">
                                <a href="chuyen-muc.php?id=<?php echo $row['machuyenmuc']; ?>" class="author">
        ...
        <div class="row space-db--30">
            <div class="col-lg-8 mb--30">
                <div class="promo-wrapper promo-type-one">
                    <a href="#" class="promo-image  promo-overlay bg-image" data-bg="">
                        <img src="http://localhost:8080/webbansach/admin/upload/breadcrumb_bg2.png" alt="">
                    </a>
            ...
            <div class="col-lg-4 mb--30">
                <div class="promo-wrapper promo-type-two ">
                    <a href="tat-ca-san-pham.php" class="promo-image promo-overlay bg-image" data-bg="">
                        <img src="http://localhost:8080/webbansach/admin/upload/hbanner_img3.png" alt=""
                            style="height: 245px;">
                    </a>
                </div>
            </div>
                            ...
                            <div class="card-image">
                                ...
                                <div class="hover-contents">
                                    <a href="san-pham.php?id=<?php echo $row['masanpham']; ?>" class="hover-image">
                                        <img src="<?php echo $row['anhphu1']; ?>" alt=""
