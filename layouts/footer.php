    ...
    $(document).ready(function () {
        ...
        if (giohang == null) {
            ...
            for (var i = 0; i < giohang.length; i++) {
                ...
                $('.sanpham_giohang').append('<div class=" single-cart-block "> <div class="cart-product"> <a href="san-pham.php?id=' + giohang[i].masanpham + '" class="image"> <img style="width: 100px; height: 100px;" src="http://localhost:8080/webbansach/' + giohang[i].anhchinh + '" alt=""> </a> <div class="content"> <h3 class="title"><a href="san-pham.php?id=' + giohang[i].masanpham + '">' + giohang[i].tensanpham + '</a> </h3> <p class="price"><span class="qty">' + giohang[i].soluong + ' ×</span> ' + giohang[i].giaban + 'đ</p> </div> </div> </div>')
                tien += gia
            }
