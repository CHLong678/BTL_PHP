            ...
            <div class="col-lg-5 mb--30">
              ...
              "asNavFor": ".product-slider-nav"
                    ...
                    <div class="single-slide">
                        <img src="http://localhost:8080/webbansach/<?php echo $sanpham['anhchinh']; ?>" alt="">
                    </div>
                    <div class="single-slide">
                        <img src="http://localhost:8080/webbansach/<?php echo $sanpham['anhphu1']; ?>" alt="">
                    </div>
                    <div class="single-slide">
                        <img src="http://localhost:8080/webbansach/<?php echo $sanpham['anhphu2']; ?>" alt="">
                    </div>
                    <div class="single-slide">
                        <img src="http://localhost:8080/webbansach/<?php echo $sanpham['anhphu3']; ?>" alt="">
                    </div>
                    <div class="single-slide">
                        <img src="http://localhost:8080/webbansach/<?php echo $sanpham['anhphu4']; ?>" alt="">
                    </div>
                </div>
            ...
            <div class="col-lg-7">
                <div class="product-details-info pl-lg--30 ">
                    ...
                    <ul class="list-unstyled">
                        <li>Giảm: <span class="list-value"> -
                                <?php echo number_format($sanpham['giagoc'] - $sanpham['giaban']); ?></span></li>
                        <li>Chuyên mục: <a href="#" class="list-value font-weight-bold">
                                <?php echo $cm['tenchuyenmuc']; ?></a></li>
                    ...
                    <div class="add-to-cart-row">
                        ...
                        <div class="add-cart-btn">
                            <a href="" class="btn btn-outlined--primary themgiohang"><span
                                    class="plus-icon">+</span>Thêm Giỏ Hàng</a>
                        </div>
                    </div>
                </div>
            </div>
