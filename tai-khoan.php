												...
												<?php } else { ?>
													<?php while ($row = $donhang->fetch_assoc()) { ?>
														<tr>
															...
															<td><a href="xem-chi-tiet.php?id=<?php echo $row['madonhang'] ?>" class="btn">Xem Chi Tiết</a>
															</td>
														</tr>
													<?php } ?>
												<?php } ?>
										...
										<form method="POST">
											<div class="row">
												<div class="col-12  mb--30">
													<input id="display-name" placeholder="Họ tên.." type="text" required name="tenkhachhang"
														value="<?php echo $kh['tenkhachhang']; ?>">
												</div>
												<div class="col-12  mb--30">
													<input id="display-name" placeholder="Số điện thoại.." type="text" required name="sodienthoai"
														value="<?php echo $kh['sodienthoai']; ?>">
												</div>
												<div class="col-12  mb--30">
													<input id="display-name" placeholder="Địa chỉ.." type="text" required name="diachi"
														value="<?php echo $kh['diachi']; ?>">
												</div>
												<div class="col-12  mb--30">
													<input id="display-name" placeholder="Tài khoản.." type="text" required name="taikhoan"
														disabled value="<?php echo $kh['taikhoan']; ?>">
												</div>
												<div class="col-12  mb--30">
													<input id="current-pwd" placeholder="Mật khẩu mới.." type="password" name="matkhau">
												</div>
												<div class="col-12">
