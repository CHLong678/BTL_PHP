								...
								<div id="billing-form" class="mb-40">
									...
									<div class="row">
										<div class="col-md-6 col-12 mb--20">
											<label>Họ tên</label>
											<input type="text" value="<?php echo $khachhang["tenkhachhang"]; ?>"
												placeholder="Họ tên người nhận" required class="hoten" disabled>
										</div>
										<div class="col-md-6 col-12 mb--20">
											<label>Số điện thoại</label>
											<input type="text" placeholder="Số điện thoại" value="<?php echo $khachhang["sodienthoai"]; ?>"
												required class="sodienthoai" disabled>
										</div>
