					...
					<table class="table order-details-table">
						...
						<tbody>
							<?php while ($row = $chitietdonhang->fetch_assoc()) { ?>
								<tr>
									<td><a
											href="http://localhost:8080/webbansach/san-pham.php?id=<?php echo $row['masanpham']; ?>"><?php echo $row['tensanpham']; ?></a>
										<strong>× <?php echo $row['soluong']; ?></strong>
									</td>
									<td><span><?php echo number_format($row['giaban'] * $row['soluong']); ?>đ</span></td>
								</tr>
							<?php } ?>
						</tbody>
